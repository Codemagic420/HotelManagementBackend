...
class AuthControllerIntegrationTest {
    ...
    void setUp() {
        ...
        loginResponse = new LoginResponse("eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0ZXN0dXNlciIsImlhdCI6MjI0N", "Bearer", 86400000L);
    }
    ...
    void testLogoutSuccess() throws Exception {
        mockMvc.perform(post("/api/auth/logout")
                .contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", loginResponse.getTokenType() + " " + loginResponse.getAccessToken()))
                .andDo(print())
                .andExpect(status().isOk());
    }
