...
public class Neo4jRoomTypeController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Neo4jRoomType> getById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Neo4jRoomType> update(@PathVariable Long id, @RequestBody Neo4jRoomType roomType) {
